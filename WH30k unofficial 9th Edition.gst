...
<gameSystem id="218d-602b-768b-7f56" name="WH30k unofficial 9th Edition" revision="3" battleScribeVersion="2.03" authorName="Lothar" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  ...
  <forceEntries>
    <forceEntry id="4f23-15fd-4ba5-d3b2" name="Patrol Detachment (-2 CP)" hidden="false">
      ...
      <forceEntries>
        <forceEntry id="0dd2-4f4a-bff0-439a" name="Patrol Detachment" hidden="false">
          <categoryLinks>
            ...
            <categoryLink id="cc64-959f-c2b8-b7d1" name="Fly" hidden="false" targetId="150d-38e7-8c25-f30c" primary="false"/>
            ...
            <categoryLink id="b2e0-3db9-ad2d-88ae" name="No Force Org" hidden="false" targetId="e662-8e86-894a-6009" primary="false"/>
      ...
      <categoryLinks>
        ...
        <categoryLink id="fcb2-2a88-529d-741f" name="No Force Org" hidden="false" targetId="e662-8e86-894a-6009" primary="false"/>
      </categoryLinks>
    </forceEntry>
  ...
  <entryLinks>
    ...
    <entryLink id="6949-a9b7-8c84-850d" name="Fealty" hidden="false" collective="false" import="true" targetId="7852-1619-272b-dfe0" type="selectionEntry">
      <modifierGroups>
        <modifierGroup>
          <conditions>
            <condition field="selections" scope="primary-catalogue" value="0.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="da54-2db0-7d98-7b89" type="instanceOf"/>
          </conditions>
          <modifiers>
            <modifier type="set" field="hidden" value="false"/>
            <modifier type="set" field="5ef5-a309-20f4-e66b" value="1.0"/>
          </modifiers>
        </modifierGroup>
      </modifierGroups>
      <categoryLinks>
  ...
  <sharedSelectionEntries>
    ...
    <selectionEntry id="7852-1619-272b-dfe0" name="Fealty" hidden="true" collective="false" import="true" type="upgrade">
      <constraints>
      ...
      <selectionEntryGroups>
        <selectionEntryGroup id="289f-e1f7-5cef-a138" name="Fealty" hidden="false" collective="false" import="true">
          <constraints>
